...
| <a name="module_<%= vueAppNameSnakeCase %>_web_oidc_role"></a> [<%= vueAppNameSnakeCase %>\_web\_oidc\_role](#module\_<%= vueAppNameSnakeCase %>\_web\_oidc\_role) | git@github.com:LeafLink/terraform-modules.git//aws/github-oidc-role | 3.40.0 |
...
| [aws_iam_policy_document.<%= vueAppNameSnakeCase %>_web_bucket](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
